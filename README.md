...
For existing generators, you might want to use `GeneratorCompat` class. It also uses Clack for prompts, but adheres to the default prompting API (Yeoman uses [Inquirer])
